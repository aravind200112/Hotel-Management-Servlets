...
<head>
<meta charset="UTF-8">
<title>Paradize-Registeration</title>
              ...
              <div class="card px-3">
                ...
                <form action=RegisterServlet method=post>
                  ...
                  <div class="class my-3">
                     ...
                     <input type="text" class="form-control" name="txtname" id="InputName1" placeholder="Enter your name" required>
                  </div>
                  <div class="class my-3">
                   
                    <input type="email" class="form-control" name="txtmail" id="InputPwd1" placeholder="Enter your email" required>
                  </div>
                  <div class="class my-3">
                   ...
                   <div class="d-flex justify-content-center mt-4">
                      ...
                      <button type=submit name="room-type" style="text-align: center;" >Submit</button>
