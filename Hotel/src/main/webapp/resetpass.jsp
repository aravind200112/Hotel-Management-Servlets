...
<body>
       ...
       <div class="row d-flex justify-content-center column" >
           <div class = "col-md-4">
              <div class="card px-3">
                <div class="card-body">
                <div class="mailform">
                <form action=ResetPassServlet method=post id="loginform">
                   <h4 class="text-center">Reset Password</h4><br>
                  <div class="class mb-3">
                     
                     <input type="password" class="form-control" name="new-password" id="InputName1" placeholder="Enter the new password" required>
                  </div>
                ...
                <div class="create-button d-flex justify-content-center mb-4">
                      ...
                      <a href="login.jsp"><button  class="mt-4" style="text-align: center;" >Login</button></a>
                      </div>
              </div>
 ...
 $(document).ready(function() {
	 	...
	 	if($("#fail").val() == "reset")
	 		{
	 		$("#disp").text("The password has been resetted successfully");
	 		}
